...
namespace NsEduCore_DAL.Models.Data
{
    public partial class NsDataContext : DbContext
    {
        public NsDataContext()
        {
        }

        public NsDataContext(DbContextOptions<NsDataContext> options)
            : base(options)
        {
        }
