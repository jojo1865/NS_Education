        ...
        ISubmit<B_PartnerItem, PartnerItem_Submit_Input_APIItem>
    {
            ...
            B_PartnerItem entity)
        {
            return new PartnerItem_GetInfoById_Output_APIItem
            {
                ...
                BSCID = entity.BSCID,
                BSC_Title = entity.B_StaticCode?.Title ?? "",
                BSC_List = await DC.B_StaticCode.GetStaticCodeSelectable(StaticCodeType.PartnerItem, entity.BSCID),
                BOCID = entity.BOCID,
                BOC_Title = entity.B_OrderCode?.Title ?? "",
                BOC_List = await DC.B_OrderCode.GetOrderCodeSelectable(OrderCodeType.PartnerItem, entity.BOCID),
                DHID = entity.DHID,
                DH_Title = entity.D_Hall?.TitleC ?? entity.D_Hall?.TitleE ?? "",
        ...
        public IQueryable<B_PartnerItem> DeleteItemsQuery(IEnumerable<int> ids)
        {
